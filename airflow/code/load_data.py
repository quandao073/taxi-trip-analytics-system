...
SPARK_STREAMING__CHECKPOINT_PATH    = os.environ.get("SPARK_STREAMING__CHECKPOINT_PATH", "hdfs://hadoop-namenode:9000/checkpoints")
SPARK_STREAMING__TRIGGER_TIME       = os.environ.get("SPARK_STREAMING__TRIGGER_TIME", "10 seconds")
HDFS__RAW_OUTPUT_PATH               = os.environ.get("HDFS__RAW_OUTPUT_PATH", "hdfs://hadoop-namenode:9000/raw_data")
